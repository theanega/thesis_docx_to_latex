...
\fancyhead[C]{\leftmark}        % Título del capítulo centrado arriba
...
\usepackage[acronym,nonumberlist,style=long,toc]{glossaries}  % Para lista de acrónimos
...
% Títulos de partes - alineados a la izquierda con quote
\makeatletter
\renewcommand{\@part}[2][]{%
