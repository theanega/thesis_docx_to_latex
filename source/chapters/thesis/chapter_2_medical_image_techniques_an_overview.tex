...
curves. The most common model used is the Tofts model \citep{toftsMeasurementBloodbrainBarrier1991} which assumes that the movemenet of the contrast agent in the
