...
On this scale (\hyperref[_Ref220408295]{Figure~\ref{fig:2.1}}), soft tissues
...
\caption[Hounsfield units and contrast enhancement in abdominal CT]{Hounsfield units and contrast enhancement in abdominal CT.
...
\caption[Examples of MRI and multiparametric MRI maps]{Examples of MRI and multiparametric MRI maps.
...
(\hyperref[_Ref219584906]{Figure~\ref{fig:2.3}}).
...
whole-slide imaging (WSI) \citep{pantanowitzWholeSlideImaging2015}. Here, automated
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{fig_2_3.pdf}
\caption[From radiological imaging to histopathological examination]{From radiological imaging to histopathological examination.
