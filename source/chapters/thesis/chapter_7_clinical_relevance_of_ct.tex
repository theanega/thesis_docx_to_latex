...
\caption{Clinical validation study design.
...
\caption{Spatial architecture and habitat-volume correlations across cohorts.
...
\caption{Neoadjuvant chemotherapy remodels tumor composition.
...
\caption{Treatment and molecular context modify prognostic value in VHIO.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fig_8_6.png}
\caption{Rim metrics differ between histopathological growth patterns.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{fig_8_5.png}
\caption{Rim entropy dynamics during treatment.
