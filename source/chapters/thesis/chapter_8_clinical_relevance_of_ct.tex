...
}{Clinical Relevance of CT Habitats }}\label{clinical-relevance-of-ct-habitats}\label{ch:8}
...
\begin{table}[ht]
    \centering
    \small
    \caption[\textbf{\sffamily Clinical characteristics of the TCIA and VHIO cohorts}]{%
        \textbf{\sffamily Clinical characteristics of the TCIA and VHIO cohorts.}%
...
(\hyperref[_Ref219821801]{Figure~\ref{fig:8.2}}A). This consistency confirms that
...
tumor volume (\hyperref[_Ref219821801]{Figure~\ref{fig:8.2}}B). The strongest
...
\hyperref[_Ref219821707]{Figure~\ref{fig:8.3}}A compares habitat metrics between
...
(\hyperref[_Ref219821707]{Figure~\ref{fig:8.3}}B): high rim cellular-perfused
...
interior (\hyperref[_Ref219821707]{Figure~\ref{fig:8.3}}B).
...
\begin{table}[ht]
    \centering
    \small
    \caption[\textbf{\sffamily Cox regression for overall survival in neoadjuvant-treated TCIA patients}]{%
        \textbf{\sffamily Cox regression for overall survival in neoadjuvant-treated TCIA patients.}%
...
8.4}A, \Cref{tab:context_dependent_prognostic}). In patients receiving
...
were independently prognostic \hyperref[_Ref219821545]{Figure~\ref{fig:8.4}}B).
...
\begin{table}[ht]
    ...
    \caption[\textbf{\sffamily Context-dependent prognostic value of habitat metrics in VHIO}]{%
        \textbf{\sffamily Context-dependent prognostic value of habitat metrics in VHIO.}%
...
(\hyperref[_Ref219821448]{Figure~\ref{fig:8.5}}). Desmoplastic tumors also showed
...
(\hyperref[_Ref219821408]{Figure~\ref{fig:8.6}}A, left)---size alone does not
...
The waterfall plot (\hyperref[_Ref219821408]{Figure~\ref{fig:8.6}}B) reveals the
...
(\hyperref[_Ref219821408]{Figure~\ref{fig:8.6}}A, right), SD patients with
