...
\caption[Overview of patient cohorts used in this thesis]{Overview of patient cohorts used in this thesis.
...
metastases). \hyperref[_Ref219813073]{Figure~\ref{fig:5.1} \textbar{} Overview of
...
\caption[Habitat imaging pipeline overview]{Habitat imaging pipeline overview.
...
pipeline supports three modes (\hyperref[_Ref219813148]{Figure~\ref{fig:5.3}}):
...
\caption[Clustering scope: single-tumor, pooled, and hybrid modes]{Clustering scope: single-tumor, pooled, and hybrid modes.
