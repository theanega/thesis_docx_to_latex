...
\caption{Overview of patient cohorts used in this thesis.
...
\bottomrule
\endlastfoot
PREDICT & 10 & 42 & CT (Portal Phase), MRI & --- & Habitat model development (mpMRI-anchored) and validation (Chapter 7) \\
POEM & 6 & 6 & CT (Portal Phase), Histology (HE) & --- & Biological validation of habitat model (Chapter 7) \\
TCIA & 189 & 389 & CT (Portal Phase) & OS, DFS & Application of habitat model and clinical outcome modeling (Chapter 8) \\
VHIO & 343 & 1759 & CT (Portal Phase) & OS, PFS & Application of habitat model and clinical
...
\caption{Habitat imaging pipeline overview.
...
\caption{Clustering scope: single-tumor, pooled, and hybrid modes.
