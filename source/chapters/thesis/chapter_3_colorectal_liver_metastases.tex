...
tumor to tumor (\hyperref[_Ref219653911]{Figure~\ref{fig:3.1}}A). The three main
...
(ILN) \citep{changInfarctlikeNecrosisDistinct2012}. Usual necrosis is characterized by
...
primaries as well \citep{lataczHistopathologicalGrowthPatterns2022} (\hyperref[_Ref219653911]{Figure
...
\caption[Histopathological heterogeneity in colorectal liver metastases]{Histopathological heterogeneity in colorectal liver metastases.
...
\caption[Treatment landscape for colorectal liver metastases]{Treatment landscape for colorectal liver metastases.
...
category out of four options (\hyperref[_Ref219662305]{Figure~\ref{fig:3.3}}).
...
\caption[Response Evaluation Criteria in Solid Tumors (RECIST)]{Response Evaluation Criteria in Solid Tumors (RECIST).
