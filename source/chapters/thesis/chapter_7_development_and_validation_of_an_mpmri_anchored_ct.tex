...
reflect treatment failure due to poor drug penetration \citep{wongColorectalCancerLiver2007b}. If we could distinguish these tissue states non-invasively, we
...
\citep{federauPerfusionMeasurementBrain2014,togaoMeasurementPerfusionFraction2018}. Similarly, dynamic
...
\caption[Schematic of the mpMRI-anchored CT habitat model development]{Schematic of the mpMRI-anchored CT habitat model development.
...
\hyperref[_Ref219821967]{Figure~\ref{fig:7.2}} shows examples of CT{} habitats
...
\caption[Selection of the optimal CT representation]{Selection of the optimal CT representation.
...
\caption[Biophysical characterization of CT habitats using mpMRI]{Biophysical characterization of CT habitats using mpMRI.
...
(\hyperref[_Ref219822008]{Figure~\ref{fig:7.4}}A). CT{} habitat maps captured this
...
\hyperref[_Ref219822008]{Figure~\ref{fig:7.4}}C). H1 dominated the core (79.4\% ±
...
\caption[Spatial architecture and histopathological validation of CT habitats]{Spatial architecture and histopathological validation of CT habitats.
