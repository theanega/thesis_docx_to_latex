...
\item
  ...
  computation (raw HU, handcrafted radiomics features, deep learning
  features from a liver tumor segmentation model, and deep learning
  features from a foundation model) and identify the representation that
  yields the most biologically coherent habitats.
\item
...
course. While surgical resection offers the best chance for long-term
...
hierarchical information after being trained on extremely large
...
retained. Full methodological details are provided in \Cref{annex:development-and-validation-of-biologically-informed-ct-habitats}.
...
\item
  ...
  detailed in \Cref{annex:development-and-validation-of-biologically-informed-ct-habitats}.
\item
...
\item
  \textbf{$ADC_t$} (tissue apparent diffusion coefficient):
  a proxy for cellularity
\item
  \textbf{$f_v$} (vascular signal fraction): a measure of
  blood volume
\item
...
Both $f_v$ and K$^{trans}$ were included to capture different aspects of tumor
...
summarizes the results. Handcrafted radiomics achieved the highest biophysical separation score
...
DL-FM showed no significant separation on any metric. None of the representations 
achieved strong separation on $ADC_t$, our primary cellularity proxy. 
...
\begin{table}[t!]
    ...
    \begin{tabular}{l c c c c c c c}
        \toprule
        & \multicolumn{2}{c}{\textbf{$ADC_t$}} & \multicolumn{2}{c}{\textbf{Vascular fraction ($f_v$)}} & \multicolumn{2}{c}{\textbf{$K^{trans}$}} & \multirow{2}{*}{\textbf{\makecell{Biophysical\\Score}}} \\
...
\begin{figure}[b!]
\centering
\includegraphics[width=0.95\textwidth]{fig_7_2.png}
...
are detailed in \Cref{annex:development-and-validation-of-biologically-informed-ct-habitats}.
...
reported in \Cref{annex:development-and-validation-of-biologically-informed-ct-habitats}.
...
compartments (necrosis, fibrosis, and viable tumor) (\Cref{tab:habitat_characterization}). \Cref{fig:7.3} shows boxplots for the eight metrics with significant differences
across habitats, plus two cellularity-related metrics ($f_{in}$, $ADC_t$). Full
results with pairwise significance tests are available in \Cref{annex:development-and-validation-of-biologically-informed-ct-habitats}.
...
\subsection{Spatial Architecture and Histopathological Validation}\label{spatial-architecture-and-histopathological-validation}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{fig_7_4.png}
...
Correlations were weak and non-significant (\Cref{annex:development-and-validation-of-biologically-informed-ct-habitats}), reflecting the
...
vascular rim (H3) with highest $f_v$ and moderate-high $K^{trans}$. The
$f_v/K^{trans}$ dissociation in H3 has a plausible explanation: high vascular
...
35\%, respectively). This architecture (avascular interior, vascularized
periphery) matches the known histology of colorectal liver metastases,
where viable tumor surrounds a necrotic or fibrotic core
