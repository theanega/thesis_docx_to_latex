...
(\hyperref[_Ref219708580]{Figure~\ref{fig:4.1}}).The idea of using computers to
...
\caption[Evolution of approaches to imaging heterogeneity]{Evolution of approaches to imaging heterogeneity.
...
Importantly, morphologic response. \hyperref[_Ref219734577]{Figure~\ref{fig:4.2}}
...
\caption[Example of qualitative approach to imaging heterogeneity]{Example of qualitative approach to imaging heterogeneity.
...
\caption[Schematic comparison of radiomics feature extraction methods]{Schematic comparison of radiomics feature extraction methods.
...
and viable tumor) for several cancer types in preclinical models \citep{caranoQuantificationTumorTissue2004,divinePopulationBasedGaussianMixture2016,henningVascularNecroticTumor2007} using PET and
...
3D-printed tumor moulds (\hyperref[_Ref219736071]{Figure~\ref{fig:4.4}}). The
...
patients with CRLM scheduled for hepatic resection \citep{franklinRadiologicallyDefinedHabitats2020}. Imaging-derived subregions showed good concordance with spatially
...
\caption[Examples of MRI-based habitat imaging]{Examples of MRI-based habitat imaging.
...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{@{} l >{\raggedright\arraybackslash}X c l c >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X @{}}
        ...
        \midrule
        \citep{caranoQuantificationTumorTissue2004} & Colorectal (preclinical) & MRI & K-means & 4 & No & Yes (histology) & No \\ \addlinespace
        \citep{henningMultispectralQuantificationTissue2007} & Sarcoma (preclinical) & MRI & K-means & 4 & No & Yes (histology) & No \\ \addlinespace
        \citep{chaudhuryIdentifyingMetastaticBreast2015} & Breast & MRI & K-means & 4 & No & No & Yes (molecular) \\ \addlinespace
        \citep{divinePopulationBasedGaussianMixture2016} & Breast (preclinical) & PET/MRI & GMM & 5 & No & Yes (histology) & No \\ \addlinespace
        \citep{katiyarNovelUnsupervisedSegmentation2017} & GBM (preclinical) & MRI & Spectral & 3 & No & Yes (histology) & No \\ \addlinespace
        \citep{juan-albarracinGlioblastomaVascularHabitats2018} & GBM & MRI & K-means & 4 & No & Yes (vascular) & Yes (survival) \\ \addlinespace
        \citep{jardim-perassiMultiparametricMRICoregistered2019} & Breast (preclinical) & MRI & GMM & 4 & Yes (repeatability) & Yes (histology) & No \\ \addlinespace
        \citep{franklinTumourSubregionAnalysis2020} & CRLM & MRI & K-means & 2 & No & Yes (histology) & No \\ \addlinespace
        \citep{katiyarQuantificationIntratumouralHeterogeneity2023} & CRLM & PET/MRI & Spectral & 2 & No & Yes (histology) & No \\
        \bottomrule
    \end{tabularx}
\end{table}
