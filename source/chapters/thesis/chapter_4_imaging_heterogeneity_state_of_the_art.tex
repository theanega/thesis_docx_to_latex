...
largely follows the comprehensive reviews carried out by O'Connor and colleagues \citep{oconnorQuantitativeImagingBiomarkers2008, oconnorImagingIntratumorHeterogeneity2015, oconnorCancerHeterogeneityImaging2017}.
...
analysis \citep{caranoQuantificationTumorTissue2004} and quantitative response criteria \citep{choiCorrelationComputedTomography2007, chunAssociationComputedTomography2009}. The field was formalized in the early 2010s
...
late 2010s marked the entry of deep learning into radiology \citep{lakhaniDeepLearningChest2017} and foundation models for cancer imaging biomarkers have
...
replace handcrafted features. \citet{lakhaniDeepLearningChest2017} demonstrated
...
specifically designed for cancer imaging biomarker discovery \citep{paiFoundationModelCancer2024}. These developments represent a shift from handcrafted
...
Optimal response is characterized by homogeneous attenuation and sharp
tumor-liver interface. Adapted from \citep{chunAssociationComputedTomography2009}.}
\label{fig:4.2}
\end{figure}
...
\citet{choiCorrelationComputedTomography2007}, who extended RECIST by incorporating HU changes for
gastrointestinal stromal tumors (GIST) treated with imatinib, a targeted
therapy. Similar to the therapies discussed in
...
quantifiable and reproducible \citep{oconnorImagingBiomarkerRoadmap2017}. The
...
widely used was the gray-level co-occurrence matrix (GLCM) \citep{haralickTexturalFeaturesImage1973}, which counts how often specific pairs of intensity values
...
histopathological characteristics in non-small cell lung cancer \citep{kawataQuantitativeClassificationBased2012}.
...
contrast-enhanced sequences yield perfusion parameters such as K$^{trans}$
and $v_e$; and T2-weighted imaging reflects tissue water content and edema.
...
cancer studies \citep{oconnorImagingBiomarkerRoadmap2017} describes three types of
