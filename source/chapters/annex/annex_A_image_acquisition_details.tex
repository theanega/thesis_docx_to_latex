...
\midrule
$ADC_t$ & Tissue ADC & Diffusion-relaxation MRI & μm²/ms & 0.0--3.0 \\
$ADC_v$ & Vascular ADC & Diffusion-relaxation MRI & μm²/ms & 3.0--150.0 \\
$K_t$ & Tissue kurtosis excess & Diffusion-relaxation MRI & Dimensionless & 0.0--5.0 \\
$f_v$ & Vascular signal fraction & Diffusion-relaxation MRI & Normalized & 0.0--1.0 \\
$T_{2t}$ & Tissue $T_2$ & Diffusion-relaxation MRI & ms & 0.0--800.0 \\
$D_0$ & Intrinsic diffusivity & Advanced diffusion model & μm²/ms & 0.8--3.0 \\
$vCS$ & Volume-weighted cell size & Advanced diffusion model & μm & 5.0--40.0 \\
$f_{in}$ & Intracellular fraction & Advanced diffusion model & Normalized & 0.0--1.0 \\
$CD$ & Cell density & Advanced diffusion model & Cells/mm³ & 0.0--8e6 \\
$T_1$ & $T_1$ & Variable flip angle SGrE & ms & 0.0--5000.0 \\
$T_2^*$ & $T_2^*$ & Multiecho SGrE & ms & 0.0--200.0 \\
$K^{trans}$ & Capillary permeability & DCE MRI & min⁻¹ & 0.0--4.0 \\
$v_e$ & EES volume & DCE MRI & Normalized & 0.0--1.0 \\
\bottomrule
\end{tabular}
\end{table}
