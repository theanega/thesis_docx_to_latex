...
\newacronym[type=symbols]{adct}{$ADC_t$}{Tissue Apparent Diffusion Coefficient}
\newacronym[type=symbols]{adcv}{$ADC_v$}{Vascular Apparent Diffusion Coefficient}

% C
\newacronym[type=symbols]{cd}{$CD$}{Cell Density}
...
% D
\newacronym[type=symbols]{d0}{$D_0$}{Intrinsic Diffusivity}
...
% F
\newacronym[type=symbols]{fin}{$f_{in}$}{Intracellular Signal Fraction}
\newacronym[type=symbols]{fv}{$f_v$}{Vascular Signal Fraction}
...
% K
\newacronym[type=symbols]{kt}{$K_t$}{Tissue Kurtosis Excess}
\newacronym[type=symbols]{ktrans}{$K^{trans}$}{Volume Transfer Constant}
...
% T
\newacronym[type=symbols]{t1}{$T_1$}{Longitudinal Relaxation Time}
\newacronym[type=symbols]{t2star}{$T_2^*$}{Effective Transverse Relaxation Time}
\newacronym[type=symbols]{t2t}{$T_{2t}$}{Tissue Transverse Relaxation Time}
\newacronym{trg}{TRG}{Tumor Regression Grading}

% V
\newacronym[type=symbols]{vcs}{$vCS$}{Volume-Weighted Cell Size}
\newacronym[type=symbols]{ve}{$v_e$}{Extracellular Extravascular Space Volume Fraction}
\newacronym{vegf}{VEGF}{Vascular Endothelial Growth Factor}
\newacronym[type=symbols]{vp}{$v_p$}{Plasma Volume Fraction}
